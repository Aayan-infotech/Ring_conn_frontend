      ...
      <div className="container">
        <div className="row gy-5">
          ...
          <div className="col-lg-2 col-md-6 col-6">
            ...
            <ul className="footer-links">
              <li><Link to="/products/gen2">RingConn Gen 2</Link></li>
              <li><Link to="/products/gen2air">RingConn Gen 2 Air</Link></li>
              <li><Link to="/products/gen1">RingConn Gen 1</Link></li>
              <li><Link to="/products/chargingdock">Charging Dock</Link></li>
              <li><Link to="/products/protectorcolors">Protector Colors</Link></li>
              <li><Link to="/products/protector">Ring Protector</Link></li>
            </ul>
          </div>
          ...
          <div className="col-lg-2 col-md-6 col-6">
            ...
            <ul className="footer-links">
              <li><Link to="/download/android">Android App</Link></li>
              <li><Link to="/download/ios">iOS App</Link></li>
              <li><Link to="/download/3dmodels">3D Model Files</Link></li>
              <li><Link to="/download/manual">User Manual</Link></li>
              <li><Link to="/support/faq">FAQ</Link></li>
              <li><Link to="/support/guides">User Guides</Link></li>
            </ul>
          </div>
        ...
        <div className="d-flex flex-column flex-md-row justify-content-between align-items-center">
          <p className="copyright mb-3 mb-md-0">
            ...
            <span className="d-none d-md-inline"> | </span><br className="d-md-none" />
            Designed by <a href="https://aayaninfotech.com" target="_blank" rel="noopener noreferrer">Aayan Infotech</a>
          </p>
